...
#define USBD_HID_IF_NUM                 (USBD_ADC_ENABLE * 2 + 0)
#define USBD_CDC_ACM_CIF_NUM            (USBD_ADC_ENABLE * 2 + USBD_HID_ENABLE + 0 )
#define USBD_CDC_ACM_DIF_NUM            (USBD_ADC_ENABLE * 2 + USBD_HID_ENABLE + 1 )
#define USBD_MSC_IF_NUM                 (USBD_ADC_ENABLE * 2 + USBD_HID_ENABLE + USBD_CDC_ACM_ENABLE * 2)
...
#define USBD_HID_IF_STR_NUM        (3 + USBD_STRDESC_SER_ENABLE + USBD_ADC_ENABLE * 3 )
#define USBD_CDC_ACM_CIF_STR_NUM   (3 + USBD_STRDESC_SER_ENABLE + USBD_ADC_ENABLE * 3 + USBD_HID_ENABLE + 0 )
#define USBD_CDC_ACM_DIF_STR_NUM   (3 + USBD_STRDESC_SER_ENABLE + USBD_ADC_ENABLE * 3 + USBD_HID_ENABLE + 1 )
#define USBD_MSC_IF_STR_NUM        (3 + USBD_STRDESC_SER_ENABLE + USBD_ADC_ENABLE * 3 + USBD_HID_ENABLE + USBD_CDC_ACM_ENABLE * 2 )
